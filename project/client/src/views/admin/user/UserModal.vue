...
const handleSubmit = async () => {
    if (userData.password !== null && (userData.password !== confirmPassword.value)) {
    ...
    if (props.statusForm === 'ADD') {
        ...
        await userStore.fetchEditUser(props.userId, userData, props.page, props.perPage);
    }
    ...
    <div class="admin-modal__container">
        ...
        <div class="admin-modal__section" v-click-outside="handleCloseModal">
            <div class="modal-header">
                <h5>{{ statusForm === 'ADD' ? 'Thêm mới người dùng' : 'Cập nhật người dùng' }}</h5>
            ...
            <div class="modal-body">
                <form @submit.prevent="handleSubmit" class="row g-3 form-group">
                    <div class="form-item col-md-6">
                        ...
                        <input v-model="userData.fullName" type="text" class="form-control" id="fullName">
                    </div>
                    <div class="form-item col-md-6">
                    ...
                    <div class="form-item col-md-6">
                        ...
                        <input v-model="userData.email" type="text" class="form-control" id="email" required>
                    </div>
                    <div class="form-item col-md-6">
                    ...
                    <div class="form-item col-md-6">
                        ...
                        <b-datepicker v-model="userData.dateOfBirth" id="dateOfBirth" />
                    </div>
                    <div class="form-item col-md-6">
                        <label for="category" class="form-label">Quyền người dùng</label>
                        <select v-model="userData.roleId" class="form-select" id="category" required>
                            <option :value="role.id" v-for="role in roles" :key="role.id">
                                {{ role?.id == 'ADMIN' ? 'Quản trị viên' : 'Người dùng' }}
                            </option>
                        </select>
                    </div>
